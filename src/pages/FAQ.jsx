...
const faqs = [
    ...
    { question: "Koje su opcije plaćanja?", answer: "Kartice i bankovne uplate su podržane."},
    ...
    return (
        ...
        <section className="faq container">
            ...
            <div style={{marginTop: 12}}>
                {faqs.map((f, i) => (
                    <Accordion key={i} index={i} question={f.question} answer={f.answer} openIndex={openIndex} setOpenIndex={setOpenIndex}/>
                ))}
            </div>
        </section>
        </>
